...
def call_server():                                                        #Definimos una función call_server
    ...
    client = actionlib.SimpleActionClient('do_car_wash', DoCarWashAction) #Declaramos nuestra Acción Cliente con nombre do_wash_car        
    ...
    goal.number_of_cars = 5                                               #Definimos el número de Automóviles
...
if __name__ == '__main__':
    ...
    try:
        rospy.init_node('node_action_client')                            #Definimos el nombre de nuestro nodo
