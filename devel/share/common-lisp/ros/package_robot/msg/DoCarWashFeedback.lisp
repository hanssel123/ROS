...
(cl:defmethod cl:initialize-instance :after ((m <DoCarWashFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoCarWashFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package_robot-msg:<DoCarWashFeedback> is deprecated: use package_robot-msg:DoCarWashFeedback instead.")))
...
(cl:defmethod percent_cars_complete-val ((m <DoCarWashFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package_robot-msg:percent_cars_complete-val is deprecated.  Use package_robot-msg:percent_cars_complete instead.")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DoCarWashFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Feedback~%float32 percent_cars_complete~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DoCarWashFeedback)))
  "Returns full string definition for message of type 'DoCarWashFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Feedback~%float32 percent_cars_complete~%~%~%"))
